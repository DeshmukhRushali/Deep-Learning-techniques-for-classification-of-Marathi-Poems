...
def multichannel_model(length,vocab_size):
    ...
    pool2 = MaxPooling1D(pool_size=7)(drop2)
    flat2 = Flatten()(pool2)
    #Channel 3
    ...
    pool4 = MaxPooling1D(pool_size=7)(drop4)
    flat4 = Flatten()(pool4)
    #merging channels
...
history =model.fit([sequences_matrix,sequences_matrix,sequences_matrix,sequences_matrix],trainLabels,batch_size=64,epochs=10,
...
accr = model.evaluate([test_sequences_matrix,test_sequences_matrix,test_sequences_matrix,test_sequences_matrix],testLabels,verbose=1)
y_pred = model.predict([test_sequences_matrix,test_sequences_matrix,test_sequences_matrix,test_sequences_matrix])
