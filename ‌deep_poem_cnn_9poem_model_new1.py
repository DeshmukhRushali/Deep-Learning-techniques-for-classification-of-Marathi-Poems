...
history =model.fit([sequences_matrix,sequences_matrix,sequences_matrix],trainLabels,batch_size=64,epochs=10,
...
y_pred = model.predict([test_sequences_matrix,test_sequences_matrix,test_sequences_matrix])
